...
class Style {
  ...
  static TextStyle alltext_Large_red = TextStyle(
    fontFamily: 'Outfit',
    fontWeight: FontWeight.w700,
    color: ColorsCode.snackbar_error_color,
    fontSize: Dimensions.fontSizeLarge,
  ...
  static TextStyle alltext_small_primaryreview = TextStyle(
    fontFamily: 'Outfit',
    fontWeight: FontWeight.w400,
    color: ColorsCode.primary_color,
    fontSize: Dimensions.fontSizeSmall,
    decoration: TextDecoration.underline,
    decorationColor: ColorsCode.primary_color,
  );
  ...
  static TextStyle alltext_Large_primary = TextStyle(
    ...
    color: ColorsCode.primary_color,
    fontSize: Dimensions.fontSizeLarge,
  );  static TextStyle alltext_Large_primarypsychology = TextStyle(
    fontFamily: 'Outfit',
    fontWeight: FontWeight.w400,
    color: ColorsCode.primary_color_psychology,
    fontSize: Dimensions.fontSizeLarge,
  );
...
// ignore: constant_identifier_names
  ...
  static const under_line_block_text_style_psychology = TextStyle(
    fontFamily: 'Outfit',
    fontWeight: FontWeight.w400,
    color: ColorsCode.primary_color_psychology,
    fontSize: 10,
  ...
  static const robotoRegular = TextStyle(
    ...
    color: ColorsCode.text_primary_color,
    fontSize: 12,
  );static const robotoRegularRed = TextStyle(
    fontFamily: 'Outfit',
  ...
  static const robotoRegular8 = TextStyle(
    fontFamily: 'Outfit',
    fontWeight: FontWeight.w400,
    color: ColorsCode.text_primary_color,
    fontSize: 8,
  ...
  static const orderError12 = TextStyle(
    fontFamily: 'Outfit',
    fontWeight: FontWeight.w500,
    color: ColorsCode.text_field_error_colors,
    fontSize: 12,
  ...
  // ignore: constant_identifier_names
  static const submit_button_style_bold = TextStyle(
    fontFamily: 'Outfit',
    fontWeight: FontWeight.w900,
